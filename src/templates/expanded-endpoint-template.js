        ...
        <div class="doc-introduction-content-block">
          <div class="doc-introduction-left-block">
            ${html`
              ...
              <h2 part="section-operation-summary"> ${unsafeHTML(marked(path.shortSummary || `${path.method.toUpperCase()} ${path.path}`))}</h2>
              ${path.isWebhook
            ...
            ${path.description ? html`
              <div class="m-markdown"> ${unsafeHTML(marked(path.description))}</div>` : ''}
